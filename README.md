...
| EP47                   | Gestión de confirmación de pago                     | Como usuario, quiero recibir una confirmación visual y por correo al realizar un pago, para tener la seguridad de que la transacción fue exitosa.                                                                                                                                                                                                                                   | No Corresponde              | No Corresponde          |
