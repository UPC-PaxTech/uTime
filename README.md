...
| US01                   | Registro de un cliente                                     | **Como** cliente, **quiero** registrarme proporcionando mis datos personales, **para** crear una cuenta.                                                                   | Criterio 1: <br> <br> Dado que el cliente desea registrarse en la plataforma <br> Cuando complete el formulario con su nombre, correo electrónico, número de teléfono y una contraseña válida <br >Entonces el sistema deberá registrar su cuenta y mostrar un mensaje de confirmación. <br> <br> Criterio 2 <br><br> Dado que el cliente ha registrado su cuenta con un correo válido <br>Cuando el registro se complete correctamente <br>Entonces el sistema deberá enviar un correo de confirmación al cliente y permitirle iniciar sesión.                                                                                                                                                                                                                                                                                                 | EP01                       |
| US02                   | Registro de un salón de belleza/barbería                   | **Como** dueño/administrador, **quiero** poder registrar mi negocio, **para** gestionar mis servicios en la plataforma.                                                    | Criterio 1: <br> <br> Dado que el dueño/administrador<br> Cuando complete el formulario con su nombre, correo electrónico, número de teléfono, nombre del salón, dirección y una contraseña válida <br >Entonces el sistema deberá registrar su cuenta y mostrar un mensaje de confirmación. <br> <br> Criterio 2 <br><br> Dado que el dueño del salón ha registrado su cuenta con un correo válido <br>Cuando el registro se complete correctamente <br>Entonces el sistema deberá enviar un correo de confirmación al cliente y permitirle iniciar sesión.                                                                                                                                                                                                                                                                                    | EP01                       |
...
| US03                   | Inicio de sesión del usuario                               | **Como** usuario, **quiero** iniciar sesión con mi correo y contraseña, **para** acceder a mi cuenta.                                                                      | Criterio 1: <br> <br> Dado que el cliente ya tiene una cuenta registrada <br> Cuando acceda a la configuración de seguridad de su cuenta <br >Entonces el sistema deberá permitirle activar el 2FA. <br> <br> Criterio 2 <br><br> Dado que el cliente ingresa credenciales incorrectas <br> Cuando el cliente intente iniciar sesión <br> Entonces el sistema deberá mostrar un mensaje de error indicando las credenciales son incorrectas.                                                                                                                                                                                                                                                                                                                                                                                                    | EP02                       |
| US04                   | Recuperación de contraseña                                 | **Como** usuario, **quiero** recuperar el acceso a mi cuenta si olvido la contraseña, **para** poder usar la plataforma nuevamente.                                        | Criterio 1: <br> <br> Dado que el cliente ha olvidado su contraseña <br> Cuando haga clic en el enlace "¿Olvidaste tu contraseña?" en la pantalla de inicio de sesión e ingrese su correo registrado <br >Entonces el sistema deberá enviar un enlace de restablecimiento de contraseña a ese correo.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | EP02                       |
...
| US09                   | Visualización de los horarios                              | **Como** dueño/administrador, **quiero** visualizar los horarios disponibles , **para** saber cuándo mis trabajadores puede aceptar citas.                                 | Criterio 1: <br> <br> Dado que el cliente desea visualizar los horarios disponibles<br> Cuando acceda a la barbería o salón de belleza de su preferencia <br >Entonces el sistema debe de mostrar el horario a tiempo real de cada trabajador <br> <br> Criterio 2 <br><br> Dado que el cliente esta en el horario se la compañia, <br> cuando el cliente seleccione un bloque horario, entonces el sistema debe de mostrar los servicios disponibles                                                                                                                                                                                                                                                                                                                                                                                           | EP05                       |
| US10                   | Configuración de los horarios                              | **Como** dueño/administrador, **quiero** configurar los horarios de atención de mis trabajadores, **para** definir sus días y horas disponibles.                           | Criterio 1: <br> <br> Dado que el dueño/administrador desea añadir la disponibilidad de sus trabajadores<br> Cuando acceda a la opción de gestionar trabajadores e ingrese los datos de sus empleados <br> Entonces el sistema debera de actualizar los horarios con los nuevos abajadores y mostrarlo en la plataforma. <br> <br> Criterio 2 <br><br>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | EP05                       |
...
| US11                   | Visualización de beneficios de suscripción                 | **Como** dueño/administrador, **quiero** ver qué beneficios incluye cada plan, **para** elegir el más adecuado para mí.                                                    | Escenario 1: Comparación de beneficios de subscripciones<br>**Dado que** un dueño/administrador visita la sección de planes de suscripción, <br/>**Cuando** hace click en una de las subscripción disponibles, <br/>**Entonces** el sistema debe mostrar claramente los beneficios de cada uno en formato lista o tabla comparativa.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | EP07                       |
| US12                   | Visualización de precios                                   | **Como** dueño/administrador, **quiero** ver los precios de cada plan, **para** tomar decisiones según mi presupuesto.                                                     | Escenario 1: Comparación de precios<br> **Dado que** un usuario accede a la sección de suscripciones,<br>**Cuando** selecciona un tipo de plan,<br/>**Entonces** el sistema debe mostrar el precio mensual y/o anual actualizado antes de que realice el pago.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | EP07                       |
| US13                   | Estado y nivel de suscripción                              | **Como** dueño/administrador, **quiero** ver el estado de mi suscripción actual, **para** saber su está activa y cuándo expira.                                            | Escenario 1: Visualización del estado de la suscripción<br>**Dado que** un usuario ha iniciado sesión,<br>**Cuando** accede a la sección de suscripción,<br>**Entonces** el sistema debe mostrar el nombre del plan actual, el estado (activo/inactivo) y la fecha de vencimiento o renovación.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | EP07                       |
| US14                   | Contratación de plan de suscripción                        | **Como** dueño/administrador, **quiero** contratar un plan, **para** activar sus beneficios en mi cuenta.                                                                  | Escenario 1: Selección de plan y redirección a pago<br>**Dado que** el salón ha iniciado sesión,<br>**Cuando** selecciona un plan y hace clic en "Pagar",<br>**Entonces** el sistema debe redirigirlo al proceso de pago y mostrar un resumen del plan seleccionado.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | EP08                       |
...
| US21                   | Administración de servicios ofrecidos                      | **Como** dueño/administrador, **quiero** agregar, editar o eliminar servicios, **para** mantener mi catálogo actualizado.                                                  | Escenario 1: Registro de nuevo servicio<br>Dado que la empresa desea ofrecer un nuevo servicio,<br>Cuando accede a la sección de servicios y completa los campos requeridos,<br>Entonces el sistema debe guardar y mostrar el nuevo servicio con su duración y precio.<br><br> Escenario 2: Modificación de un servicio existente<br>Dado que un servicio necesita ser actualizado,<br>Cuando se edita su precio, duración o nombre,<br>Entonces el sistema debe reflejar los cambios de forma inmediata en la plataforma.                                                                                                                                                                                                                                                                                                                      | EP04                       |
| US22                   | Gestión de trabajadores                                    | **Como** dueño/administrador, **quiero** añadir o quitar trabajadores, **para** organizar quién ofrece cada servicio.                                                      | Escenario 1: Registro de nuevo trabajador<br>Dado que la empresa contrata a un nuevo colaborador,<br>Cuando completa su información en el formulario de registro,<br>Entonces el sistema debe guardar los datos y mostrar al trabajador en la lista activa.<br><br> Escenario 2: Modificación de información de un trabajador<br>Dado que se necesita actualizar datos personales o de contacto,<br>Cuando se realiza la edición,<br>Entonces el sistema debe reflejar los nuevos datos correctamente.                                                                                                                                                                                                                                                                                                                                          | EP04                       |
| US23                   | Gestión de cuentas bancarias                               | **Como** dueño/administrador, **quiero** registrar, modificar o eliminar cuentas bancarias, **para** administrar correctamente los pagos recibidos.                        | Escenario 1: Registro de cuenta bancaria<br>Dado que la empresa desea recibir pagos,<br>Cuando registra una nueva cuenta bancaria,<br>Entonces el sistema debe almacenarla y asociarla a la empresa.<br><br> Escenario 2: Edición o eliminación de cuenta bancaria<br>Dado que una cuenta requiere actualización o eliminación,<br>Cuando se realiza esta acción desde la configuración,<br>Entonces el sistema debe reflejar el cambio de inmediato.                                                                                                                                                                                                                                                                                                                                                                                           | EP04                       |
| EP12                   | **Gestión de notificaciones**                              | **Como** usuario, **quiero** recibir notificaciones personalizadas sobre mis citas, pafos y promociones, **para** estar siempre informado.                                 | Escenario 1: Gestión del carrito con límites por plan<br>Dado que el cliente agrega productos al carrito,<br>Cuando el sistema valida el límite según el plan contratado,<br>Entonces se deben permitir las acciones según corresponda (agregar, modificar o restringir).<br><br> Escenario 2: Visualización del total<br>Dado que hay varios productos en el carrito,<br>Cuando el cliente visualiza el resumen,<br>Entonces el sistema debe mostrar el total y el precio unitario de cada producto.<br><br> Escenario 3: Vaciar carrito<br>Dado que el cliente cambia de opinión,<br>Cuando presiona "vaciar carrito",<br>Entonces el sistema debe eliminar todos los productos del carrito de compras.                                                                                                                                       | EP05                       |
| US24                   | Recepción de notificaciones del estado de la cita          | **Como** cliente, **quiero** recibir notificaciones sobre confirmación, cancelación o modificación de citas, **para** estar al tanto de mis reservas.                      | Escenario 1: Confirmación automática<br>Dado que un cliente agenda una cita,<br>Cuando esta se confirma exitosamente,<br>Entonces el sistema debe enviar un correo de confirmación.<br><br> Escenario 2: Recordatorios previos<br>Dado que se acerca la hora de la cita,<br>Cuando falten 24 horas y luego 1 hora,<br>Entonces el sistema debe enviar un recordatorio automático al cliente.<br><br> Escenario 3: Notificación al salón por cambios<br>Dado que un cliente cancela o reprograma su cita,<br>Cuando se realiza la acción,<br>Entonces el sistema debe notificar al salón de forma inmediata.                                                                                                                                                                                                                                     | EP07                       |
| US25                   | Alertas por vencimiento o fallo de pago                    | **Como** usuario, **quiero** ser alertado si hay un problema con mi pago o si está por vencer mi suscripción, **para** tomar acciones a tiempo.                            | Escenario 1: Alerta de vencimiento<br>**Dado que** la suscripción está por vencer,<br>**Cuando** falten 3 días,<br>**Entonces** el sistema debe enviar un correo de aviso.<br><br>Escenario 2: Alerta por pago fallido<br>**Dado que** se intenta un cobro automático,<br>**Cuando** falla,<br>**Entonces** se debe enviar un correo y mostrar un aviso.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | EP08                       |
| US26                   | Configuración de medios de notificación                    | **Como** usuario, **quiero** elegir si recibir notificaciones por correo, SMS o dentro de la plataforma, **para** tener un mejor control de mi información.                | Escenario 1: Configuración del canal de notificación<br>Dado que un cliente desea personalizar sus alertas,<br>Cuando accede a la configuración de su cuenta,<br>Entonces el sistema debe permitirle seleccionar el canal preferido (correo, SMS o app).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | EP07                       |
| US27                   | Recepción de notificaciones sobre promociones y descuentos | **Como** cliente, **quiero** recibir promociones y descuentos que me interesen, **para** aprovechar ofertas relevantes.                                                    | Escenario 1: Gestión del carrito con límites por plan<br>Dado que el cliente agrega productos al carrito,<br>Cuando el sistema valida el límite según el plan contratado,<br>Entonces se deben permitir las acciones según corresponda (agregar, modificar o restringir).<br><br> Escenario 2: Visualización del total<br>Dado que hay varios productos en el carrito,<br>Cuando el cliente visualiza el resumen,<br>Entonces el sistema debe mostrar el total y el precio unitario de cada producto.<br><br> Escenario 3: Vaciar carrito<br>Dado que el cliente cambia de opinión,<br>Cuando presiona "vaciar carrito",<br>Entonces el sistema debe eliminar todos los productos del carrito de compras.                                                                                                                                       | EP05                       |
| EP13                   | **Landing Page**                                           | **Como** visitante, **quiero** ver una página inicial atractiva con toda la información relevante, **para** decidir si deseo registrarme o contactar.                      | No Corresponde                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | No Corresponde             |                                                 |
| US28                   | Visualización general de los servicios                     | **Como** visitante, **quiero** ver una vista general de los servicios ofrecidos, **para** entender qué tipo de atención puedo recibir.                                     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | EP08                       |
| US29                   | Visualización de beneficios                                | **Como** visitante, **quiero** ver los beneficios de usar la plataforma, **para** motivarme a registrarme.                                                                 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | EP08                       |
| US30                   | Planes y precios                                           | **Como** visitante, **quiero** ver los planes de suscripción y sus precios, **para** saber si se ajustan a mis necesidades.                                                |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | EP08                       |
| US31                   | Testimonios                                                | **Como** visitante, **quiero** leer testimonios de otros usuarios, **para** ganar confianza en la plataforma.                                                              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | EP08                       |
| US32                   | Call to action                                             | **Como** visitante, **quiero** encontrar botones de acción claros, **para** empezar a usar la plataforma fácilmente.                                                       | Escenario 1:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | EP08                       |
| US33                   | Contacto o soporte                                         | **Como** visitante, **quiero** poder contactarme con el equipo o recibir soporte, **para** resolver dudas antes de registrarme.                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | EP08                       |

### 3.2.4 Technical Stories

| **Epic/User Story ID** | **Título**                              | **Descripción**                | **Criterios de Aceptación** | **Relacion con (Epic ID)** |
|------------------------|-----------------------------------------|--------------------------------|-----------------------------|----------------------------|
| EP01                   | **Registro de usuario**                 |                                | No Corresponde              | No Corresponde             |                                                 |
| TS01                   | Validación backend de datos de registro | **Como** developer, **quiero** |                             | EP01                       |
| TS02                   | Actualización en tiempo real            |                                |                             | EP01                       |
