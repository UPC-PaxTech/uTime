...
| EP55                   | Gestión de modificación o eliminación de cuentas bancarias    | Como dueño/administrador, quiero modificar o eliminar mis cuentas bancarias registradas, para mantener actualizada mi información financiera.                                                                                      | No Corresponde              | No Corresponde          |
| EP56                   | Visualización de productos disponibles                        | Como cliente, quiero ver el listado de productos disponibles en un salón o barbería, para conocer qué opciones puedo adquirir.                                                                                                     | No Corresponde              | No Corresponde          |
| EP57                   | Gestión del carrito de compras                                                              | Como cliente, quiero agregar, eliminar o modificar la cantidad de productos en mi carrito, con o sin límite según mi plan, para controlar mi compra fácilmente.                                                                                                                                                                                                                                   | No Corresponde              | No Corresponde          |
| EP58                   | Información detallada de productos                                                              | Como cliente, quiero visualizar la imagen, descripción y precio de cada producto, para tomar decisiones de compra con información clara.                                                                                                                                                                                                                                   | No Corresponde              | No Corresponde          |
| EP59                   | Visualización de precios en el carrito                                                              | Como cliente, quiero ver el precio unitario y total de los productos añadidos a mi carrito, para saber cuánto estoy gastando antes de pagar.                                                                                                                                                                                                                                   | No Corresponde              | No Corresponde          |
| EP60                   | Vaciar carrito de compras                                                              | Como cliente, quiero tener un botón para vaciar todo mi carrito, para comenzar mi compra desde cero fácilmente si cambio de opinión.                                                                                                                                                                                                                                   | No Corresponde              | No Corresponde          |
