...
| US14                   | Contratación de plan de suscripción                        | **Como** dueño/administrador, **quiero** contratar un plan, **para** activar sus beneficios en mi cuenta.                                                                  | Escenario 1: Selección de plan y redirección a pago<br>**Dado que** el salón ha iniciado sesión,<br>**Cuando** selecciona un plan y hace clic en "Pagar",<br>**Entonces** el sistema debe redirigirlo al proceso de pago y mostrar un resumen del plan seleccionado.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | EP07                       |
...
| US19                   | Gestión de modificaciones y cancelaciones de citas         | **Como** cliente, **quiero** modificar o cancelar citas con anticipación, **para** reorganizar mis tiempos.                                                                | Escenario 1: Cancelación por parte del cliente<br>Dado que un cliente ya no puede asistir a su cita,<br>Cuando realiza la cancelación antes de la hora programada,<br>Entonces el sistema debe cancelar la cita respetando las políticas del salón.<br><br> Escenario 2: Reprogramación por parte del cliente<br>Dado que el cliente desea cambiar la fecha o hora de su cita,<br>Cuando selecciona una nueva franja horaria disponible,<br>Entonces el sistema debe actualizar la cita con la nueva información.<br><br> Escenario 3: Cancelación por parte del salón<br>Dado que el salón necesita cancelar una cita previamente agendada,<br>Cuando ejecuta esta acción desde la plataforma,<br>Entonces el sistema debe enviar una notificación por correo al cliente.                                                                      | EP09                       |
| US20                   | Historial de modificaciones de citas                       | **Como** cliente, **quiero** ver los cambios realizados a mis citas, **para** tener un seguimiento completo de mis actividades.                                            | Escenario 1: Registro automático de cancelación<br>Dado que se cancela una cita,<br>Cuando esto ocurra,<br>Entonces el sistema debe guardar el evento en el historial del cliente o salón.<br><br> Escenario 2: Registro automático de reprogramación<br>Dado que una cita ha sido modificada,<br>Cuando se cambia la fecha u hora,<br>Entonces se debe registrar el cambio en el historial para consulta futura.                                                                                                                                                                                                                                                                                                                                                                                                                               | EP09                       |
...
| US28                   | Visualización general de los servicios                     | **Como** visitante, **quiero** ver una vista general de los servicios ofrecidos, **para** entender qué tipo de atención puedo recibir.                                     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | EP12                       |
| US29                   | Visualización de beneficios                                | **Como** visitante, **quiero** ver los beneficios de usar la plataforma, **para** motivarme a registrarme.                                                                 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | EP12                       |
| US30                   | Planes y precios                                           | **Como** visitante, **quiero** ver los planes de suscripción y sus precios, **para** saber si se ajustan a mis necesidades.                                                |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | EP12                       |
| US31                   | Testimonios                                                | **Como** visitante, **quiero** leer testimonios de otros usuarios, **para** ganar confianza en la plataforma.                                                              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | EP12                       |
| US32                   | Call to action                                             | **Como** visitante, **quiero** encontrar botones de acción claros, **para** empezar a usar la plataforma fácilmente.                                                       | Escenario 1:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | EP12                       |
| US33                   | Contacto o soporte                                         | **Como** visitante, **quiero** poder contactarme con el equipo o recibir soporte, **para** resolver dudas antes de registrarme.                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | EP12                       |
