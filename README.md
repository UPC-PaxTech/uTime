...
| EP06                   |	Gestión y visualización de citas   | Como usuario, quiero visualizar, gestionar, modificar y cancelar mis citas, para tener control sobre mi agenda y organizar mejor los servicios ofrecidos.| No Corresponde| No Corresponde|
|EP07| Gestión de sistema de notificaciones | Como usuario, quiero recibir y configurar notificaciones sobre mis citas, para mantenerme informado y adaptar la forma en que recibo los avisos según mi preferencia.| No Corresponde| No Corresponde|
...
| US40                   | Visualización de productos en el marketplace          | Como cliente,<br>Quiero ver el listado de productos disponibles junto con su imagen, descripción y precio,<br>Para elegir lo que deseo comprar con mayor información.                                                              | Escenario 1: Visualización de catálogo<br>Dado que el cliente visita la tienda de un salón,<br>Cuando accede a la sección de productos,<br>Entonces el sistema debe mostrar la imagen, descripción y precio de cada artículo.<br><br> Escenario 2: Detalle de producto<br>Dado que el cliente desea más información,<br>Cuando selecciona un producto,<br>Entonces el sistema debe mostrar sus características completas.                                                                                                                                                                                                                                                                                                                                                                                                                       | EP05                                            |
| US41                   | Gestión del carrito de compras          | Como cliente,<br>Quiero agregar, modificar, eliminar productos del carrito y ver el total de la compra,<br>Para tener control sobre mi pedido.                                                                                     | Escenario 1: Gestión del carrito con límites por plan<br>Dado que el cliente agrega productos al carrito,<br>Cuando el sistema valida el límite según el plan contratado,<br>Entonces se deben permitir las acciones según corresponda (agregar, modificar o restringir).<br><br> Escenario 2: Visualización del total<br>Dado que hay varios productos en el carrito,<br>Cuando el cliente visualiza el resumen,<br>Entonces el sistema debe mostrar el total y el precio unitario de cada producto.<br><br> Escenario 3: Vaciar carrito<br>Dado que el cliente cambia de opinión,<br>Cuando presiona "vaciar carrito",<br>Entonces el sistema debe eliminar todos los productos del carrito de compras. | EP05                                            |
